...
EXPORTS=_lp_solve_version,_malloc,_free,_make_lp,_delete_lp,_print_lp,_add_constraint,_add_constraintex,_set_obj_fn,_set_obj_fnex,_set_maxim,_set_minim,_set_int,_set_binary,_solve,_print_objective,_print_solution,_print_constraints,_print_duals,_get_objective,_get_variables,_get_Ncolumns,_set_timeout
